<?php
    ...
    if($_SESSION['nivel'] == 2){
        ...
        <a href="avaliacao.php">Artigos</a>
                  <!-- criar post -->
                  <a href="publicar_adm.php">Criar post</a>
                ...
                <input type="submit" class="pesquisar_sala" value="Pesquisar">
               
                <input type="text" name="aluno" class="aluno_pesquisa">   
                <input type="submit" class="pesquisar_aluno" value="Pesquisar">
