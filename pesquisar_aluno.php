...
<?php
    $sql = "select * from tb_usuario where nm_usuario like '$aluno%' and nr_serie = '$sala'";
    ...
    if($resposta = $mysqli->query($sql)){
        ...
        <?php if($nivel_aluno!=2){?><p><?php echo $nome_aluno; ?> <a id="excluir" class="btn btn-danger">Deletar</a></p><?php }?>
            
                <div class="confirmar">
                    <p>Deseja deletar essa conta?</p>
                    <a href="deletar.php?deletar_usuario=<?php echo $cod_usuario; ?>">SIM</a>
                    <a id="rejeitar">NAO</a>
